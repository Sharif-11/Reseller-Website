    ...
    <div className="bg-gradient-to-b from-gray-50 to-white p-4 md:p-8 min-h-screen">
      <div className="max-w-6xl mx-auto">
          ...
          {supportChannels.map((channel, index) => (
            ...
            >
              <div className="flex items-start gap-3 md:gap-4">
                <div className="p-2 md:p-3 rounded-full bg-white shadow-xs">
                  {channel.icon}
                </div>
                <div>
                  <h3 className="text-sm md:text-base font-semibold text-gray-800">{channel.title}</h3>
        ...
        <div className="mt-8 md:mt-12 bg-white rounded-lg shadow-sm p-5 md:p-6">
          <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-3 md:mb-4">সাপোর্ট সময়সূচী</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm md:text-base">
            <div>
              <p className="text-gray-600"><span className="font-medium text-gray-800">সাপোর্ট সময়:</span> সকাল ৯টা - রাত ১০টা</p>
              <p className="text-gray-600"><span className="font-medium text-gray-800">বন্ধের দিন:</span> শুক্রবার</p>
            </div>
            <div>
              <p className="text-gray-600"><span className="font-medium text-gray-800">দ্রুত প্রতিক্রিয়া:</span> হোয়াটসঅ্যাপ ও ফোন কল</p>
              <p className="text-gray-600"><span className="font-medium text-gray-800">ইমেইল রেসপন্স:</span> ২৪ ঘন্টার মধ্যে</p>
            </div>
          </div>
        </div>
      </div>
