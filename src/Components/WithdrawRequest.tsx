    ...
    <div className='flex border-b border-gray-200 mb-4'>
      <button
        className={`py-2 px-4 font-medium text-sm ${
          activePolicyTab === 'bKash' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500'
        }`}
      ...
      <button
        className={`py-2 px-4 font-medium text-sm ${
          activePolicyTab === 'Nagad' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500'
        }`}
      ...
      <form onSubmit={handleSubmit} className='bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6'>
        <div className='space-y-4'>
          ...
          <div>
            ...
            {selectedWallet && <p className='mt-1 text-xs text-gray-500'>ন্যূনতম উইথড্র: ৫০৳</p>}
          </div>
