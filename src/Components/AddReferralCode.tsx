...
const AddReferralCode = () => {
  ...
  return (
    <div className='min-h-screen flex items-start justify-center p-4 sm:p-6 md:p-8'>
      <div className='bg-white rounded-xl shadow-lg w-full max-w-md sm:max-w-lg md:max-w-xl overflow-hidden'>
        {/* Header Section */}
        <div className='bg-gradient-to-r from-indigo-600 to-indigo-700 p-4 sm:p-6 text-center text-white'>
          <h1 className='text-sm sm:text-md font-bold'>রেফারাল কোড যোগ করুন</h1>
        ...
        <div className='p-4 sm:p-6'>
          ...
          <form onSubmit={formik.handleSubmit} className='space-y-4'>
            ...
            <div>
              ...
              <input
                type='text'
                className={`w-full text-xs sm:text-sm px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${
            ...
            <button
              type='submit'
              disabled={isLoading}
              className='w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 text-xs sm:text-sm'
            >
              {isLoading ? (
                <>
                  <svg
