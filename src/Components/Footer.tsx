    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          {/* Legal Links */}
          <div className="mb-6">
            <h4 className="text-lg font-semibold mb-4 border-b border-blue-400 pb-2">গুরুত্বপূর্ণ লিংক</h4>
            <ul className="space-y-2">
              <li><a href="/privacy-policy" className="hover:text-blue-400 transition">প্রাইভেসি পলিসি</a></li>
              <li><a href="/return-refund-policy" className="hover:text-blue-400 transition">রিটার্ন ও রিফান্ড পলিসি</a></li>
              <li><a href="/terms-conditions" className="hover:text-blue-400 transition">শর্তাবলী</a></li>
              <li><a href="/shipping-policy" className="hover:text-blue-400 transition">শিপিং পলিসি</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6 text-center text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} রিসেলার বিডি. সকল স্বত্ব সংরক্ষিত
          </p>
          <p className="mt-2 text-sm">
            ডিজাইন ও ডেভেলপমেন্ট - রিসেলার বিডি টিম
          </p>
        </div>
      </div>
    </footer>
