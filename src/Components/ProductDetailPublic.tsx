            ...
            <div className="grid grid-cols-4 gap-3">
              {allImages.map((img, index) => (
                <button
                  ...
                  className={`rounded-lg border-2 overflow-hidden transition-all ${mainImage === img.imageUrl ? 'border-blue-500' : 'border-gray-200'}`}
                >
                  <img
                    src={img.imageUrl}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${product.stockSize > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
